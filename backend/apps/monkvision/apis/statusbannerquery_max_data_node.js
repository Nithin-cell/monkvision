...
exports.doService = async jsonReq => {
    ...
    const truePercent = Math.fround(currentData.max_data).toFixed(2);
    ...
    if (parseFloat(threshold) > parseFloat(truePercent)) textexplanation = `${currentData.common_name} - ${currentData.node_hostname}, Threshold at: ${threshold}`;
    else textexplanation = `${currentData.common_name} - ${currentData.node_hostname}, Threshold at: ${threshold}`;
